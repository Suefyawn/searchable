...
export const DISCOS: Disco[] = [
  { slug: "lesco", short: "LESCO", name: "Lahore Electric Supply Company", region: "Central Punjab", cities: ["Lahore", "Kasur", "Okara", "Sheikhupura", "Nankana Sahib"], billUrl: "https://www.lesco.gov.pk/Modules/CustomerBillNC/CheckBill.asp", billUrlLabel: "lesco.gov.pk (Customer Bill)", helpline: "118", website: "https://www.lesco.gov.pk" },
