...
export const HUB_COPY = {
  ...
  businesses: { title: "Pakistan Business Directory by City and Category", description: "Find businesses across Pakistan by category and city: hospitals, universities, solar installers, car dealers and banks, with phone numbers and addresses." },
  professionals: { title: "Find a Professional in Pakistan: Doctors, Lawyers", description: "Verified professionals in Pakistan: doctors, lawyers, engineers, architects, electricians, tutors and more, by city, with profiles, fees and contact details." },
  data: { title: "Pakistan Prices Today: Petrol, Gold, Dollar, KSE-100", description: "Today's prices and rates in Pakistan with history: petrol and diesel, gold and silver per tola, dollar, riyal and dirham, KSE-100, the SBP policy rate and inflation." },
