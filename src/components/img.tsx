 ...
 */
export function Img({ src, alt, aspect = "16/9", className, sizes = "(min-width: 1024px) 800px, 100vw", priority, eager, fit = "cover", width }: { src: string; alt: string; aspect?: string; className?: string; sizes?: string; priority?: boolean; /** Fetch at once (normal priority) even when not visible yet: the other slides of a carousel. */ eager?: boolean; fit?: "cover" | "contain"; /** Master width when known; trims the srcset. */ width?: number | null }) {
