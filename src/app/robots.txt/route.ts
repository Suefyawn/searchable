...
export function GET() {
  ...
  lines.push(`# Agentmap: ${SITE.url}/.well-known/ai-catalog.json (the agent catalog; a comment because robots.txt validators reject unknown directives)`, `Sitemap: ${SITE.url}/sitemap.xml`, `Sitemap: ${SITE.url}/news-sitemap.xml`, `Host: ${SITE.url}`, "");
