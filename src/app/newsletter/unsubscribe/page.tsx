  ...
  return (
    <div className="container-x py-20 text-center">
      <div className="mx-auto max-w-md surface p-8">
        ...
        <Link href="/" className="mt-6 inline-flex h-10 items-center bg-ink-900 px-4 text-sm font-medium text-white hover:bg-ink-800 dark:bg-white dark:text-ink-900">
          Back to Searchable
        </Link>
      </div>
    </div>
