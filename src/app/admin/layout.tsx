...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const groups: AdminNavGroup[] = [
    { title: "Desk", items: [{ href: "/admin", label: "Dashboard" }, { href: "/admin/articles", label: "Articles", count: c.drafts }, { href: "/admin/ideas", label: "Story ideas" }, { href: "/admin/backlog", label: "Backlog" }, { href: "/admin/automation", label: "Automation" }, { href: "/admin/data", label: "Data hub" }, { href: "/admin/media", label: "Media" }] },
