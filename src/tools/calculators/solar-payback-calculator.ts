...
export const solarPaybackCalculator: ToolDefinition = {
  ...
  category: "solar",
  name: "Solar System Size & Payback Calculator",
  shortName: "Solar Payback",
  description: "How many kW of solar you need for your monthly units, what it costs, how much you save, and how fast it pays for itself.",
  keywords: ["solar calculator pakistan", "solar system size", "solar panel cost", "net metering savings", "5kw solar price", "10kw solar system", "solar payback period", "solar for home"],
  version: "1.0.0",
  ...
  fields: [
    ...
    { key: "exportRate", label: "Net-metering export rate", type: "number", unit: "PKR/unit", default: 27, min: 0, max: 60, step: 0.5, help: "What the DISCO credits for units you export." },
  ...
  compute(input) {
    ...
    const savings = selfUse * num(input, "unitRate", 45) + exported * num(input, "exportRate", 27);
    ...
    return {
      ...
      warnings: ["Net-metering rules and export rates are under review by NEPRA; savings depend on how much you use during daylight. Batteries are not included."],
    };
  },
...
**Payback** = installed cost ÷ annual savings. Panels are warranted for 25 years; inverters typically need replacement once in that period, which the lifetime figure approximates with a 10% haircut.`,
  faqs: [
    ...
    { question: "What is net metering?", answer: "A bi-directional meter that credits units you export to the grid against units you import. Applications go through your DISCO after NEPRA's licence process." },
