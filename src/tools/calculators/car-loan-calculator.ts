...
export const carLoanCalculator: ToolDefinition = {
  ...
  category: "cars",
  name: "Car Loan & Lease Calculator",
  shortName: "Car Loan",
  description: "Monthly instalment, total mark-up and total cost for a car loan or lease from any Pakistani bank, at KIBOR-linked rates.",
  keywords: ["car loan calculator", "car finance pakistan", "car lease calculator", "auto loan installment", "KIBOR car financing", "meezan car ijarah", "bank car loan monthly installment", "car installment plan"],
  version: "1.0.0",
