...
export const zakatCalculator: ToolDefinition = {
  ...
  shortName: "Zakat",
  description: "Work out whether you owe zakat this year and exactly how much, using the gold or silver nisab at today's prices.",
  keywords: ["zakat calculator", "nisab 2026", "zakat on gold", "zakat on savings", "zakat pakistan", "how much zakat", "nisab silver", "zakat on cash"],
  version: "1.0.0",
