...
export const electricityBillCalculator: ToolDefinition = {
  ...
  description: "Estimate your monthly LESCO, IESCO, K-Electric or any DISCO bill from units consumed, including GST, FC surcharge and duties.",
  keywords: ["electricity bill calculator", "LESCO bill", "IESCO bill", "K-Electric bill", "units to bill", "bijli bill calculator", "NEPRA tariff", "per unit rate"],
  version: "1.0.0",
