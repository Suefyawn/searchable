...
export const plotSizeConverter: ToolDefinition = {
  ...
  category: "property",
  name: "Plot Size Converter (Marla, Kanal, Sq Ft, Sq Yards)",
  shortName: "Plot Size",
  description: "Convert marla, kanal, acre, square feet, square yards and square metres — with both the Punjab (272 sq ft) and Karachi (225 sq ft) marla standards.",
  keywords: ["marla to square feet", "kanal to marla", "1 kanal in sq ft", "5 marla plot size", "10 marla in square feet", "square yards to marla", "plot size converter", "gaz to marla"],
  version: "1.0.0",
