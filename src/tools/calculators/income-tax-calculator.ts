...
export const incomeTaxCalculator: ToolDefinition = {
  ...
  description: "Calculate your annual and monthly income tax under the latest FBR slabs for salaried and non-salaried individuals.",
  keywords: ["income tax", "salary tax", "FBR tax calculator", "tax slabs 2025-26", "tax on salary", "withholding tax salary", "salary tax calculator pakistan"],
  version: "1.1.0",
