...
export const homeLoanCalculator: ToolDefinition = {
  ...
  category: "finance",
  name: "Home Loan / House Finance Calculator",
  shortName: "Home Loan",
  description: "Monthly instalment, total mark-up and affordability for a house loan or Islamic home finance in Pakistan at KIBOR-linked rates.",
  keywords: ["home loan calculator", "house finance pakistan", "mortgage calculator", "meezan home finance", "house loan installment", "KIBOR home loan", "apna ghar", "housing finance"],
  version: "1.0.0",
