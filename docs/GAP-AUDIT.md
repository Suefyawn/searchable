...
| Tools built | 🟡 40 of 50; 2026-09-18 added passport fee (DGIP charts), NADRA fees (official schedule), vehicle transfer fee (Punjab Excise), CGPA (new education category), gold converter, solar panel count, electricity units, battery backup, fuel average, all picked by Semrush pk volume and KD |
