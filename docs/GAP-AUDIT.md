...
10. Known: paginated list pages (directory city lists, profession lists, community lists) read `searchParams` and therefore render per request instead of from the CDN; move page numbers into the path when traffic warrants it.
