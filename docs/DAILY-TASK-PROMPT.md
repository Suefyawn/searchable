...
3. GET /ideas?region=pk&limit=60 (and ?region=world, or ?topic=cricket|markets|crypto|tech|business|mma|snooker|entertainment|us) for this slot. Headlines are leads only. Pick 3 to 5 that matter to readers in Pakistan: money, prices, rules, jobs, and the sport and world stories they follow. Then top up stale desks: /context.newsDesks lists every news category, stalest first, with hoursSince its newest story. For each desk at 48 hours or more (or never filled), publish one real story from its /ideas topic if the feeds have one you can verify; prefer sport and entertainment, and skip a desk rather than stretch a weak lead. Morning and Evening may run to 7 stories in total.
